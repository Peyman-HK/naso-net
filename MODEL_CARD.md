...
|---|---|---|---|---|
| ResNet50+MeanPool | 0.690 [0.625, 0.755] | 0.737 [0.654, 0.827] | 0.704 | 0.154 |
| **Naso-Net (WMV)** | **0.696 [0.646, 0.744]** | **0.732 [0.667, 0.802]** | **0.696** | **0.094** |
| ResNet50+LSTM | 0.647 [0.589, 0.712] | 0.687 [0.616, 0.765] | 0.650 | 0.142 |
